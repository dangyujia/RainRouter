...
class RouterTransformApi extends Transform {

    Project project

    RouterTransformApi(Project project) {
    ...
    def routeMap = [:]
//    static final ROUTE_NAME = "com.example.rain.router:router:"
    static final ROUTE_NAME = "android.local.jars:jetified-router-"
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        inputs.each { input ->
            ...
            input.directoryInputs.each { dirInput ->
                println("route dirInput:" + dirInput)
                if (dirInput != null){
            ...
            input.jarInputs.each { jarInput ->
                println("route jarName:" + jarInput.name)
                if (jarInput.name.startsWith(ROUTE_NAME)) {
                    println("route jarName:  进来了")
        ...
        println("===========route transform finished:" + (eTime - millis))
    }
    ...
    private static final String ROUTE_MAP_CLASS_NAME = "com.example.rain.router.RouteMap"
    private static
...
//    static final ANNOTATION_DESC = "com/example/rain/router_api/Route;"
    static final ANNOTATION_DESC = "Lcom/example/rain/router/annotation/Route;"
    /**
     * 从class中获取Route注解信息
     * @param filePath
     */
    ...
    void addRouteMap(InputStream is, String className) {
        ...
        for (AnnotationNode an : list) {
            println("route addRouteMap: "+an.desc)
